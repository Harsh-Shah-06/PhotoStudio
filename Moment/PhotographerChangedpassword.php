            ...
            <div class="container-login100">
                ...
                <form class="login100-form validate-form" style= "margin-left: 50px;" method="post">
                    ...
                    <div class="wrap-input100 validate-input" >
                        <input class="input100" type="text" name="email" value="<?php echo $e?>" id="email"   placeholder="Enter Email" readonly="">
                    ...
                    <div class="text-center p-t-12">
                        ...
                        <a class="txt2" href="Photographer_Account.php">
                            <h6>Home</h6></a>
                        ...
                        if (!empty($_POST['oldpassword']) && !empty($_POST['newpassword']) && !empty($_POST['cpassword']) && !empty($_POST['email']))
                        {
                            ...
                            if (strlen($_POST['newpassword']) >= 8 && strlen($_POST['cpassword']) >= 8)
                            {
                                ...
                                } else
                                {
                                    ...
                                    $update = "update photographerdata set `Password`='$newpassword' where `Email`='$email'";
