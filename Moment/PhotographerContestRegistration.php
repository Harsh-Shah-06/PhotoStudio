            ...
            <div class="container-login100">
                ...
                <form class="login100-form validate-form" style= "margin-left: 50px;" method="post" enctype="multipart/form-data" >
                    ...
                    <div class="wrap-input100 validate-input" style="margin-top:10px;" >
                        <input class="input100" type="text" name="txt_email" id="txt_email"  value=<?Php  echo $e ;?>  placeholder="Email"    >
                    ...
                    <div class="wrap-input100 validate-input" >
                        <input class="input100" type="text" name="txt_firstname" id="txt_firstname"   placeholder="FirstName"  >
                        <span class="error"></span>
                        <span class="focus-input100"></span>
                        <span class="symbol-input100">
                    ...
                    <div class="wrap-input100 validate-input">
                        <input class="input100" type="text" name="txt_lastname" id="txt_lastname"   placeholder="LastName" >
                        <span class="error"></span>
                        <span class="focus-input100"></span>
                        <span class="symbol-input100">
                            <i class="fa fa-lock" aria-hidden="true"></i>
                    ...
                    <div class="wrap-input100 validate-input"  >
                        <?php
                        echo "<select class='input100'  style='outline: none;'   name='city' ><option>Select City</option>";
                    ...
                    <div class="wrap-input100 validate-input">
                        <input class="input100" type="file" name="image1" id="image1"    >
                        <span class="error"></span>
                        <span class="focus-input100"></span>
                        <span class="symbol-input100">
                            <i class="fa fa-lock" aria-hidden="true"></i>
                    ...
                    <div class="wrap-input100 validate-input">
                        <input class="input100" type="file" name="image2" id="image2"    >
                        <span class="error"></span>
                        <span class="focus-input100"></span>
                        <span class="symbol-input100">
                            <i class="fa fa-lock" aria-hidden="true"></i>
                    ...
                    <div class="wrap-input100 validate-input">
                        <input class="input100" type="file" name="image3" id="image3"    >
                        <span class="error"></span>
                        <span class="focus-input100"></span>
                        <span class="symbol-input100">
                            <i class="fa fa-lock" aria-hidden="true"></i>
                    ...
                    <div class="text-center p-t-12">
                        ...
                        <a class="txt2" href="PhotographerContest.php">
                            <h5>Back </h5></a><br/>
                                ...
                                if (isset($_FILES["image$i"]['name']))
                                {
                                    ...
                                    if (!empty($name[$i]))
                                    {
                                        ...
                                        if (move_uploaded_file($tmp_name[$i], $location . $name[$i]))
                                        {
                                              if ($err == 0)
                                            {
                                                echo "<script>swal('Good job!', 'Data Uploaded!', 'success');</script>";
                                            }
                                            else
                                            {
