...
<div id="page_wrapper">
    ...
    <ul class="cg__resMenu">
        <li class="cg__resMenu-back">
            <span class="cg__resMenu-backIcon glyphicon glyphicon-chevron-left"></span><a href="customeraccount.php#" class="cg__resMenu-backLink">Back</a>
        <li><a class="active" href="customeraccount.php"><span>Home</span></a></li>
        <li><a href="myorder.php"><span>My Order</span></a></li>
        <li><a href="customercategory.php"><span>Category</span></a></li>
        <li><a href="customerphotographer.php"><span>Photographer Profile</span></a></li>
        <li><a href="UserChangedPassword.php"><span>Changed Password</span></a></li>
        <li><a href="customerprofile.php"><span>Profile</span></a></li>
                            ...
                            <div class="sh-component menu-wrapper">
                                ...
                                <div class="cg__menuWrapper">
                                    ...
                                    <ul class="cg__mainMenu clearfix">
                                        ...
                                        <li><a href="customerphotographer.php"><span>Photographer Profile</span></a></li>
                                        <li><a href="UserChangedPassword.php"><span>Changed Password</span></a></li>
                                        <li><a href="customerprofile.php" ><span>Profile</span></a>
                                        <li> <a href="Logout.php "><span>Logout</span></a></li>
            ...
            <ul>	<!-- SLIDE  -->
                <li data-index="rs-1" data-transition="slidevertical" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb="images/slide01.jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    ...
                    <div class="tp-caption  "
                         ...
                         style="z-index: 5; white-space: nowrap; font-size: 65px; line-height: 120px; font-weight: 700; color: rgba(255,255,255,1);font-family:Montserrat;">Moment Photo Studio  </br><hr><h2>Welcome <?php echo $f ?>&nbsp;<?php echo  $l?></h2></div>
