...
$sq ="SELECT * from photographerdata where Email='$e'";
...
$sql ="SELECT Id,Email,Amount,ScheduleDate,BookingDate,Category,Scategory,PId,Status FROM bookingorder where PId='$pi'";
